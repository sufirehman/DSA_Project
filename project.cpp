...
void find_Substrings(int no,char* str,bool chxk)
{
	...
	if(result == 1)
	{
		...
		cout<<"    || Corpus<"<<str<<"> DOES NOT belong to Corpus "<<no<<" ||"<<endl ;
		//	cout<<"\t\tNO SUCH DNA Exists";
        }
...
int main (){
    ...
    string DNAs[] = { "ATTAATTA", "TAGCTAGC", "CGCGATAT", 
	...
	cout<<"              ======================================================================================="<<endl;			
	cout<<"              ======================================================================================="<<endl;		
	cout<<"              ==================== To Generate a DNA                   ..Press 1 ===================="<<endl;	
	cout<<"              ==================== To Comapre two DNA                  ..Press 2 ===================="<<endl;
	cout<<"              ==================== To Conver DNA into Rna and Protien  ..Press 3 ===================="<<endl;
 	cout<<"              ======================================================================================="<<endl;
 	cout<<"              ======================================================================================="<<endl;
 	cout<<"              ======================================================================================="<<endl;
	...
	switch(number){
		...
		cout<<endl<<"\t Enter # of lobes of DNA pattern : ";
		cin>>n;
...
//cout<<DNA.size();
	...
	//converting in to mRNA 
	Convert_to_mRNA(DNA,DNA.size());
	
	//showing mRNA
	cout << "\n\nmRNA:\n";
	ifstream mRNAfile("mRNA.txt");
	string mRNA;
	if (mRNAfile.is_open()) {
		while (!mRNAfile.eof()) {
			getline(mRNAfile, mRNA);
			cout<< mRNA << endl;
		}
	}
	mRNAfile.close();

	//converting and showing PROTIEN sequiences
	cout << "\n\n\nprotine:";
	mRNAfile.open("mRNA.txt");
	if (mRNAfile.is_open()) {
		while (!mRNAfile.eof()) {
			getline(mRNAfile, mRNA);
			convert_to_Protien(mRNA, mRNA.size());
		}
	}
